...
/***/ function(module, exports, __webpack_require__) {
	...
	var triangle = new _content2.default('#triangle');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BlackTriangle = (function () {
	  function BlackTriangle(selector) {
	    (0, _classCallCheck3.default)(this, BlackTriangle);

	    this.angle = 0;
	    this.innerEl = document.querySelector(selector).querySelector('.BlackTriangle-inner');
	  }

	  (0, _createClass3.default)(BlackTriangle, [{
	    key: 'rotate',
